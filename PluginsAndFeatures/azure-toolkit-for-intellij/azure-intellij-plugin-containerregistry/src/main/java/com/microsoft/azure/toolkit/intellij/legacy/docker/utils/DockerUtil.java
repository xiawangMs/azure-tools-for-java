...
public class DockerUtil {
     ...
     * build image.
     */
    @AzureOperation(name = "to_3rd/docker.build_image.image|dir|host", params = {"imageNameWithTag", "dockerDirectory", "docker.getHost()"}, type = AzureOperation.Type.TASK)
     ...
     */
    @AzureOperation(name = "to_3rd/docker.push_image.image|registry", params = {"targetImageName", "registryUrl"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
    ...
    @AzureOperation(name = "to_3rd/docker.ping_host.host", params = {"docker.getHost()"}, type = AzureOperation.Type.TASK)
