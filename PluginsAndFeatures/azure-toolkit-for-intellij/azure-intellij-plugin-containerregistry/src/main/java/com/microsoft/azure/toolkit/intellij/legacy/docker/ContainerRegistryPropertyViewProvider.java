...
public class ContainerRegistryPropertyViewProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "action/container.create_registry_properties_editor.registry", params = {"virtualFile.getName()"},type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
