...
public class ContainerRegistryPropertyViewProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "user/container.create_registry_properties_editor.registry", params = {"virtualFile.getName()"},type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
