...
public class DeploymentPropertyViewProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "action/arm.create_deployment_properties_editor.deployment", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
