...
public class ResourceTemplateViewProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "action/arm.create_deployment_editor.deployment", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
