...
public class UpdateDeploymentDialog extends AzureDialogWrapper {
    ...
    protected void doOKAction() {
        ...
        final AzureString title = OperationBundle.description("action/arm.update_deployment.deployment", deploymentName);
        AzureTaskManager.getInstance().runInBackground(title, false, this::updateDeployment);
        close(OK_EXIT_CODE, true);
    }

    @AzureOperation(name = "action/arm.update_deployment.deployment", params = {"this.deployment.getName()"}, type = AzureOperation.Type.ACTION)
