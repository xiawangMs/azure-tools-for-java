...
public class CreateDeploymentDialog extends AzureDialogWrapper {
    ...
    protected void doOKAction() {
        ...
        final AzureString title = OperationBundle.description("user/arm.create_deployment.deployment", deploymentName);
    ...
    @AzureOperation(name = "user/arm.create_deployment.deployment", params = {"deploymentName"}, type = AzureOperation.Type.ACTION)
