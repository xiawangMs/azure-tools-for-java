...
public class CreateDeploymentDialog extends AzureDialogWrapper {
    ...
    protected void doOKAction() {
        ...
        final AzureString title = OperationBundle.description("action/arm.create_deployment.deployment", deploymentName);
    ...
    @AzureOperation(name = "action/arm.create_deployment.deployment", params = {"deploymentName"}, type = AzureOperation.Type.ACTION)
