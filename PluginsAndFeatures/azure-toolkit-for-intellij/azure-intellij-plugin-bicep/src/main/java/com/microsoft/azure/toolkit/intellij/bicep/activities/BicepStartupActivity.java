...
public class BicepStartupActivity implements StartupActivity.DumbAware {
    ...
    public void runActivity(@Nonnull Project project) {
        ...
        if (!isDotnetRuntimeReady()) {
            ...
            AzureMessager.getMessager().warning(".NET runtime was not found or is out of date, Bicep language support was disabled. To use bicep features, please configure the path for .NET runtime and reopen the project", null, openSettingsAction);
            return;
        }
