...
public class FunctionEnableRemoteDebuggingAction {
    ...
    private static final String CONFIRM_MESSAGE = "Are you sure to %s remote debugging for %s?, to learn more, please refer <a href=\"https://aka.ms/func-remotedebug-intellij\">document</a>";
    ...
    private static Action<?> generateDebugAction(@Nonnull FunctionAppBase<?, ?, ?> app, @Nullable Project project) {
        ...
        return new Action<>(Action.Id.of("function.remote_debugging.app"), (d, e) -> remoteDebuggingAction.handle(app, e), new ActionView.Builder("Debug"));
    }
}
