...
public class TriggerFunctionAction {
    ...
    @AzureOperation(name = "to_3rd/function.trigger_with_http_client.function", params = {"functionEntity.getName()"},type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
