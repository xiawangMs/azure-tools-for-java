...
public enum AppServiceStreamingLogManager {
    ...
    @AzureOperation(name = "user/appservice.close_log_stream.app", params = {"nameFromResourceId(appId)"}, type = AzureOperation.Type.SERVICE)
    ...
    @AzureOperation(name = "user/appservice.open_log_stream.app", params = {"nameFromResourceId(resourceId)"}, type = AzureOperation.Type.SERVICE)
