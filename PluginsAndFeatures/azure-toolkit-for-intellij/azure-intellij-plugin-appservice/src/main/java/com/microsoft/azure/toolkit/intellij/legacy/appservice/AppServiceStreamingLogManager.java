...
public enum AppServiceStreamingLogManager {
    ...
    @AzureOperation(name = "action/appservice.close_log_stream.app", params = {"nameFromResourceId(appId)"}, type = AzureOperation.Type.SERVICE)
    ...
    @AzureOperation(name = "action/appservice.open_log_stream.app", params = {"nameFromResourceId(resourceId)"}, type = AzureOperation.Type.SERVICE)
    private void showAppServiceStreamingLog(Project project, String resourceId, ILogStreaming logStreaming) {
        ...
        final AzureString title = OperationBundle.description("action/appservice.open_log_stream.app", ResourceUtils.nameFromResourceId(resourceId));
