...
public class AzureSdkArtifactGroupPanel {
    ...
    private static class DependencyTypeSelector extends DefaultActionGroup {
        ...
        private DependencyTypeSelector(Consumer<? super DependencyType> onTypeSelected, DependencyType type) {
            ...
            final AnAction maven = createAction(MAVEN.getName(), AzureIconLoader.loadIcon(AzureIconSymbol.FunctionApp.MODULE), () -> this.setSelectedType(MAVEN));
            final AnAction gradle = createAction(GRADLE.getName(), AzureIconLoader.loadIcon(AzureIconSymbol.FunctionApp.MODULE), () -> this.setSelectedType(GRADLE));
        ...
        public void update(@NotNull final AnActionEvent e) {
            final Icon icon = AzureIconLoader.loadIcon(AzureIconSymbol.FunctionApp.MODULE);
