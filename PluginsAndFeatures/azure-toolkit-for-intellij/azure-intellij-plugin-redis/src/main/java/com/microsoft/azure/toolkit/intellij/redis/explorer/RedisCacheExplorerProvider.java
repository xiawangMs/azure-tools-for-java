...
public class RedisCacheExplorerProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "user/redis.create_explorer_editor.redis", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
