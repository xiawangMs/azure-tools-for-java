...
public class IntelliJCosmosActionsContributorForUltimate implements IActionsContributor {
    ...
    @AzureOperation(name = "action/cosmos.open_database_tools.account", params = {"account.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
