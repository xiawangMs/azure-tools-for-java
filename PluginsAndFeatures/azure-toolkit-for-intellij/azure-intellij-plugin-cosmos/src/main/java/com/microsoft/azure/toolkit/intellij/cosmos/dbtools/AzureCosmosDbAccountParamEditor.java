...
public class AzureCosmosDbAccountParamEditor extends ParamEditorBase<AzureCosmosDbAccountParamEditor.CosmosDbAccountComboBox> {
    ...
    @AzureOperation(name = "user/cosmos.signin_from_dbtools", type = AzureOperation.Type.ACTION)
    ...
    @AzureOperation(name = "user/cosmos.create_account_from_dbtools", type = AzureOperation.Type.ACTION)
    ...
    @AzureOperation(name = "user/cosmos.select_account_dbtools.account", params = {"account.getName()"}, type = AzureOperation.Type.ACTION)
