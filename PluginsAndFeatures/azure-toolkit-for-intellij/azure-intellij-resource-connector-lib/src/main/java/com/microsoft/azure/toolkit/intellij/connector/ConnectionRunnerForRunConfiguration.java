...
public class ConnectionRunnerForRunConfiguration extends BeforeRunTaskProvider<ConnectionRunnerForRunConfiguration.MyBeforeRunTask> {
    ...
    @AzureOperation(name = "user/connector.get_task_description", type = AzureOperation.Type.ACTION)
    ...
    @Override
    @ExceptionNotification
    @AzureOperation(name = "platform/connector.setup_connection_for_configuration", type = AzureOperation.Type.ACTION)
