...
public class KubernetesServicePropertiesEditorProvider implements FileEditorProvider, DumbAware {
    ...
    @Override
    @AzureOperation(name = "platform/kubernetes.create_cluster_properties_editor.cluster", params = {"file.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
