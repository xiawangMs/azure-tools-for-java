...
public class MonkeySurveyEditor extends BaseEditor implements DumbAware {
    ...
    @AzureOperation(name = "user/feedback.close_monkey_survey", type = AzureOperation.Type.ACTION)
    ...
    private CefRequestHandlerAdapter openLinkWithLocalBrowser() {
        return new CefRequestHandlerAdapter() {
            @Override
            @AzureOperation(name = "user/feedback.open_link_from_survey", type = AzureOperation.Type.ACTION)
