...
public class RegionComboBox extends AzureComboBox<Region> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "internal/appservice.list_regions.tier|subscription", params = {"this.tier.toString()", "this.subscription.getId()"}, type = AzureOperation.Type.SERVICE)
