...
## 3.70.0
### Added
- support for remote debugging of `Azure Spring Apps`.
- support for remote debugging of `Azure Function Apps`.
- support for data management of `Azure Storage Account` in Azure Explorer.
- support for data management of `Azure Cosmos DB account` in Azure Explorer.
- support for filtering app settings of `Azure Web App/ Function App` in properties view and run configuration dialog.
