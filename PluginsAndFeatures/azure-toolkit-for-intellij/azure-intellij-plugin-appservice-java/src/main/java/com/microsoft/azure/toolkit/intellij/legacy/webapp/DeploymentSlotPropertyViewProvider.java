...
public class DeploymentSlotPropertyViewProvider extends WebAppBasePropertyViewProvider {
    ...
    @AzureOperation(name = "action/webapp.create_slot_properties_editor.slot", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
