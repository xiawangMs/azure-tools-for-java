...
public class PushToContainerRegistryAction {
    ...
    @AzureOperation(name = "boundary/acr.run_push_image_configuration.config", params = {"settings.getName()"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
