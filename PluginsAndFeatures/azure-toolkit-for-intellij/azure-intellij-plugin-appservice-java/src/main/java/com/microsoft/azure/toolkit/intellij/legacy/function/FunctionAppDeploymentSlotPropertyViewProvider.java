...
public class FunctionAppDeploymentSlotPropertyViewProvider extends WebAppBasePropertyViewProvider {
    ...
    @AzureOperation(name = "action/function.create_slot_properties_editor.slot", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
