...
public class DeployWebAppAction {
    ...
    @AzureOperation(name = "to_platform/webapp.run_deploy_configuration.app", params = {"this.webApp.getName()"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
    public void execute() {
