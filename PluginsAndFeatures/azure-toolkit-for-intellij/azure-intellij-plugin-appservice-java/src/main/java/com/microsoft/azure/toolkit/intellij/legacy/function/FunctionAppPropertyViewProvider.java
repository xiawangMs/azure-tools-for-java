...
public class FunctionAppPropertyViewProvider extends WebAppBasePropertyViewProvider {
    ...
    @AzureOperation(name = "user/function.create_app_properties_editor.app", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
