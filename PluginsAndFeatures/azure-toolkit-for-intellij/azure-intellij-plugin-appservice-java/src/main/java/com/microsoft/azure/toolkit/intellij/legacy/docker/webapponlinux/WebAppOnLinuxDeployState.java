...
public class WebAppOnLinuxDeployState extends AzureRunProfileState<AppServiceAppBase<?, ?, ?>> {
    ...
    @Override
    @AzureOperation(name = "platform/docker.deploy_image", type = AzureOperation.Type.ACTION)
    ...
    @Override
    @AzureOperation(name = "boundary/webapp.complete_deployment.app", params = {"this.deployModel.getWebAppName()"}, type = AzureOperation.Type.TASK)
