...
public class DeployFunctionAppAction {
    ...
    @AzureOperation(name = "to_platform/function.run_deploy_configuration.app", params = {"this.functionApp.getName()"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
    public void execute() {
