...
public class WebAppPropertyViewProvider extends WebAppBasePropertyViewProvider {
    ...
    @AzureOperation(name = "platform/webapp.create_app_properties_editor.app", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
