...
public class DatabaseServerParamEditor extends ParamEditorBase<DatabaseServerParamEditor.SqlDbServerComboBox> {
    ...
    @AzureOperation(name = "user/database.signin_from_dbtools", type = AzureOperation.Type.ACTION)
    ...
    @AzureOperation(name = "user/database.create_database_from_dbtools", type = AzureOperation.Type.ACTION)
    ...
    @AzureOperation(name = "user/database.select_server_dbtools.server", params = {"server.getName()"}, type = AzureOperation.Type.ACTION)
