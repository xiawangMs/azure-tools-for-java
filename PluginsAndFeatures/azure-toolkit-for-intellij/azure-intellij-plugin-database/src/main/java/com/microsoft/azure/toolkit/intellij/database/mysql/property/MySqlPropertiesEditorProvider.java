...
public class MySqlPropertiesEditorProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "action/mysql.create_server_properties_editor.server", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
