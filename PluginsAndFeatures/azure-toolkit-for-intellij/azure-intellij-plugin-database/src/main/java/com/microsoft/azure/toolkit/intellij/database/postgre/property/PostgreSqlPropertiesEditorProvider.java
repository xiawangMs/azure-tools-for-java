...
public class PostgreSqlPropertiesEditorProvider implements FileEditorProvider, DumbAware {
    ...
    @AzureOperation(name = "user/postgre.create_server_properties_editor.server", params = {"virtualFile.getName()"}, type = AzureOperation.Type.ACTION, target = AzureOperation.Target.PLATFORM)
