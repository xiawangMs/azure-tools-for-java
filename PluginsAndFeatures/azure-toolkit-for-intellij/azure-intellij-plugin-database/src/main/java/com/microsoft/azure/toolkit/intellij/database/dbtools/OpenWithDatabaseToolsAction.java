...
public class OpenWithDatabaseToolsAction {
    @AzureOperation(name = "boundary/database.open_database_tools.server", params = {"server.getName()"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
