...
public class OpenWithDatabaseToolsAction {
    @AzureOperation(name = "to_3rd/database.open_database_tools.server", params = {"server.getName()"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
