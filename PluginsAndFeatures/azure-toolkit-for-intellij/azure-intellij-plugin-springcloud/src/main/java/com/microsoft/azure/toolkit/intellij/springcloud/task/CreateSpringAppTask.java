...
public class CreateSpringAppTask implements Task {
    ...
    public void execute() {
        ...
        final SpringCloudDeploymentConfig deploymentConfig = SpringCloudDeploymentConfig.builder().runtimeVersion(RuntimeVersion.JAVA_17.toString()).capacity(1).build();
