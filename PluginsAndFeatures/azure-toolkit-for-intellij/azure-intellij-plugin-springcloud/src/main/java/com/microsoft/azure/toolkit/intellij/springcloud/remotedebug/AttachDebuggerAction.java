...
public class AttachDebuggerAction {
    ...
    @AzureOperation(name = "action/springcloud.start_remote_debugging.instance", params = {"appInstance.getName()"}, type = AzureOperation.Type.ACTION)
    ...
    @AzureOperation(name = "action/springcloud.start_remote_debugging.app", params = {"app.getName()"}, type = AzureOperation.Type.ACTION)
