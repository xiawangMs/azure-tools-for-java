...
public class AttachDebuggerAction {
    ...
    @AzureOperation(name = "to_platform/springcloud.start_debug_configuration.instance", params = {"appInstance.getName()"}, type = AzureOperation.Type.TASK, target = AzureOperation.Target.PLATFORM)
