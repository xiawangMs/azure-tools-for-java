...
public class AzureSdkExampleService {
    ...
    @AzureOperation(name = "to_3rd/sdk.load_artifact_example.url", params = "entity.getRawUrl()")
    ...
    @AzureOperation(name = "to_3rd/sdk.load_library_examples_entities")
    ...
    @AzureOperation(name = "to_3rd/sdk.load_library_example_entities")
