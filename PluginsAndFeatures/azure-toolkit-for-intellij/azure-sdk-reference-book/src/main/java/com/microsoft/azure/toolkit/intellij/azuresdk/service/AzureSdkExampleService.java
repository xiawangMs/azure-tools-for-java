...
public class AzureSdkExampleService {
    ...
    @AzureOperation(name = "to_3rd/sdk.load_artifact_example.url", params = "entity.getRawUrl()", type = AzureOperation.Type.REQUEST)
    ...
    @AzureOperation(name = "internal/sdk.load_all_examples", type = AzureOperation.Type.SERVICE)
    ...
    @AzureOperation(name = "to_3rd/sdk.load_library_examples_entities", type = AzureOperation.Type.TASK)
    ...
    @AzureOperation(name = "to_3rd/sdk.load_library_example_entities", type = AzureOperation.Type.TASK)
