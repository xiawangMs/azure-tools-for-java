...
public class AzureSdkProjectDependencyPanel {
    ...
    @AzureOperation(name = "action/sdk.refresh_dependency", type = AzureOperation.Type.ACTION)
    ...
    @AzureOperation(name = "action/sdk.add_dependency", type = AzureOperation.Type.ACTION)
