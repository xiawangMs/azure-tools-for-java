...
public class AzureMvpModel {
     ...
     */
    @AzureOperation(name = "internal/account.get_subscription_detail.subscription", params = {"sid"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/account.get_subscription_detail", type = AzureOperation.Type.SERVICE)
     ...
     * @return
     */
    @AzureOperation(name = "internal/arm.list_resource_groups", type = AzureOperation.Type.SERVICE)
     ...
     * @return
     */
    @AzureOperation(name = "internal/arm.delete_resource_group.rg", params = {"rgName"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/arm.list_resource_groups.subscription", params = {"sid"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/arm.get_resource_group.rg|subscription", params = {"name", "sid"}, type = AzureOperation.Type.SERVICE)
    ...
    @AzureOperation(name = "internal/arm.list_deployments", type = AzureOperation.Type.SERVICE)
    ...
    @AzureOperation(name = "azure/arm.list_deployments.subscription", params = {"sid"}, type = AzureOperation.Type.SERVICE)
     ...
     * @return
     */
    @AzureOperation(name = "azure/arm.list_deployments.rg|subscription", params = {"rgName", "sid"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/common.list_regions.subscription", params = {"sid"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/common.list_tiers", type = AzureOperation.Type.SERVICE)
