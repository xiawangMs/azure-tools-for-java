...
public class ContainerRegistryNode extends Node implements TelemetryProperties {
    ...
    @AzureOperation(name = "action/container.show_properties.container", params = {"this.name"}, type = AzureOperation.Type.ACTION)
    private void showProperties() {
        DefaultLoader.getUIHelper().openContainerRegistryPropertyView(ContainerRegistryNode.this);
    }

    @AzureOperation(name = "action/container.open_portal.container", params = {"this.name"}, type = AzureOperation.Type.ACTION)
