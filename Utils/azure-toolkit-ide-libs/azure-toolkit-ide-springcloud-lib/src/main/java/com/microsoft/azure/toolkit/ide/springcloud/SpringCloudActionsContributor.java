...
public class SpringCloudActionsContributor implements IActionsContributor {
    ...
    public static final Action.Id<Object> GROUP_CREATE_CLUSTER = Action.Id.of("user/springcloud.create_cluster.group");
    ...
    public void registerActions(AzureActionManager am) {
        ...
        final ActionView.Builder openPublicUrlView = new ActionView.Builder("Access Public Endpoint", AzureIcons.Action.BROWSER.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.open_public_url.app", ((SpringCloudApp) r).getName())).orElse(null))
        ...
        final ActionView.Builder openTestUrlView = new ActionView.Builder("Access Test Endpoint", AzureIcons.Action.BROWSER.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.open_test_url.app", ((SpringCloudApp) r).getName())).orElse(null))
        ...
        final ActionView.Builder streamLogView = new ActionView.Builder("Start Streaming Logs", AzureIcons.Action.LOG.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.open_stream_log.app", ((SpringCloudApp) r).getName())).orElse(null))
        ...
        final ActionView.Builder streamLogInstanceView = new ActionView.Builder("Start Streaming Logs", AzureIcons.Action.LOG.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.open_stream_log.instance", ((SpringCloudAppInstance) r).getName())).orElse(null))
        ...
        final ActionView.Builder createClusterView = new ActionView.Builder("Spring Apps")
            .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.create_cluster.group", ((ResourceGroup) r).getName())).orElse(null))
        ...
        final ActionView.Builder enableRemoteDebuggingView = new ActionView.Builder("Enable Remote Debugging")
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.enable_remote_debugging.app", ((SpringCloudApp) r).getName())).orElse(null))
                .enabled(s -> s instanceof SpringCloudApp && ((AzResourceBase) s).getFormalStatus().isRunning() &&
        ...
        final ActionView.Builder disableRemoteDebuggingView = new ActionView.Builder("Disable Remote Debugging")
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.disable_remote_debugging.app", ((SpringCloudApp) r).getName())).orElse(null))
                .enabled(s -> s instanceof SpringCloudApp && ((AzResourceBase) s).getFormalStatus().isRunning() &&
        ...
        final ActionView.Builder attachDebuggerToAppView = new ActionView.Builder("Attach Debugger", AzureIcons.Action.ATTACH_DEBUGGER.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.attach_debugger.app", ((SpringCloudApp) r).getName())).orElse(null))
                .enabled(s -> s instanceof SpringCloudApp && ((AzResourceBase) s).getFormalStatus().isRunning());
        ...
        final ActionView.Builder attachDebuggerView = new ActionView.Builder("Attach Debugger", AzureIcons.Action.ATTACH_DEBUGGER.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("user/springcloud.attach_debugger.instance", ((SpringCloudAppInstance) r).getName())).orElse(null))
