...
public class VirtualMachineActionsContributor implements IActionsContributor {
    ...
    public static final Action.Id<VirtualMachine> ADD_SSH_CONFIG = Action.Id.of("action/vm.add_ssh_config.vm");
    public static final Action.Id<VirtualMachine> CONNECT_SSH = Action.Id.of("action/vm.connect_using_ssh.vm");
    public static final Action.Id<VirtualMachine> SFTP_CONNECTION =  Action.Id.of("action/vm.browse_files_sftp.vm");
    public static final Action.Id<ResourceGroup> GROUP_CREATE_VM = Action.Id.of("action/vm.create_vm.group");
    ...
    public void registerActions(AzureActionManager am) {
        final ActionView.Builder addSshConfigView = new ActionView.Builder("Edit SSH Configuration", AzureIcons.Action.ADD.getIconPath())
            .title(s -> Optional.ofNullable(s).map(r -> description("action/vm.add_ssh_config.vm", ((VirtualMachine) r).getName())).orElse(null))
        ...
        final ActionView.Builder connectSshView = new ActionView.Builder("Connect Using SSH", AzureIcons.Action.CONSOLE.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("action/vm.connect_using_ssh.vm", ((VirtualMachine) r).getName())).orElse(null))
                .enabled(s -> s instanceof VirtualMachine && ((VirtualMachine) s).getFormalStatus().isRunning());
        ...
        final ActionView.Builder sftpConnectionView = new ActionView.Builder("Browse Files Using SFTP", AzureIcons.Action.SFTP.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("action/vm.browse_files_sftp.vm", ((VirtualMachine) r).getName())).orElse(null))
                .enabled(s -> s instanceof VirtualMachine && ((VirtualMachine) s).getFormalStatus().isRunning());
        ...
        final ActionView.Builder createVmView = new ActionView.Builder("Virtual Machine")
            .title(s -> Optional.ofNullable(s).map(r -> description("action/vm.create_vm.group", ((ResourceGroup) r).getName())).orElse(null))
