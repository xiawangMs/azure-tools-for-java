...
public class AzureWebAppMvpModel {
     ...
     */
    @AzureOperation(name = "internal/webapp.create_app.app|subscription|image", params = {"model.getWebAppName()", "model.getSubscriptionId()", "model.getPrivateRegistryImageSetting().getImageNameWithTag()"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/docker.update_image.app|image", params = {"nameFromResourceId(webAppId)", "imageSetting.getImageNameWithTag()"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "user/webapp.create_app.app", params = {"model.getWebAppName()"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/webapp.create_deployment.deployment|app", params = {"model.getNewSlotName()", "model.getWebAppName()"}, type = AzureOperation.Type.SERVICE)
    ...
    @AzureOperation(name = "internal/webapp.upload_artifact.artifact|app", params = {"file.getName()", "deployTarget.name()"}, type = AzureOperation.Type.SERVICE)
     ...
     */
    @AzureOperation(name = "internal/webapp.update_deployment_settings.deployment|app", params = {"slot.entity().getName()", "slot.entity().getWebappName()"}, type = AzureOperation.Type.SERVICE)
