...
public class FunctionAppActionsContributor implements IActionsContributor {
    ...
    public static final Action.Id<FunctionAppBase<?, ?, ?>> ENABLE_REMOTE_DEBUGGING = Action.Id.of("action/function.enable_remote_debugging.app");
    public static final Action.Id<FunctionAppBase<?, ?, ?>> DISABLE_REMOTE_DEBUGGING = Action.Id.of("action/function.disable_remote_debugging.app");
    public static final Action.Id<FunctionAppBase<?, ?, ?>> REMOTE_DEBUGGING = Action.Id.of("action/function.start_remote_debugging.app");
    public static final Action.Id<FunctionAppDeploymentSlot> SWAP_DEPLOYMENT_SLOT = Action.Id.of("action/function.swap_deployment.deployment|app");
    public static final Action.Id<FunctionApp> REFRESH_FUNCTIONS = Action.Id.of("action/function.refresh_functions.app");
    public static final Action.Id<FunctionEntity> TRIGGER_FUNCTION = Action.Id.of("action/function.trigger_func.trigger");
    public static final Action.Id<FunctionEntity> TRIGGER_FUNCTION_IN_BROWSER = Action.Id.of("action/function.trigger_func_in_browser.trigger");
    public static final Action.Id<FunctionEntity> TRIGGER_FUNCTION_WITH_HTTP_CLIENT = Action.Id.of("action/function.trigger_function_with_http_client.trigger");
    ...
    public void registerActions(AzureActionManager am) {
        ...
        final ActionView.Builder swapView = new ActionView.Builder("Swap With Production")
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.swap_deployment.deployment|app",
        ...
        final ActionView.Builder refreshView = new ActionView.Builder("Refresh", AzureIcons.Action.REFRESH.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.refresh_functions.app", ((FunctionApp) r).getName())).orElse(null))
        ...
        final ActionView.Builder triggerView = new ActionView.Builder("Trigger Function")
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.trigger_func.trigger", ((FunctionEntity) s).getName())).orElse(null))
        ...
        final ActionView.Builder triggerInBrowserView = new ActionView.Builder("Trigger Function In Browser")
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.trigger_func_in_browser.trigger", ((FunctionEntity) s).getName())).orElse(null))
                .enabled(s -> s instanceof FunctionEntity && AzureFunctionsUtils.isHttpTrigger((FunctionEntity) s));
        ...
        final ActionView.Builder triggerWIthHttpClientView = new ActionView.Builder("Trigger Function with Http Client")
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.trigger_function_with_http_client.trigger",
        ...
        final ActionView.Builder downloadCliView = new ActionView.Builder("Download")
                .title(s -> description("action/function.download_core_tools"));
        ...
        final ActionView.Builder configCliView = new ActionView.Builder("Configure")
                .title(s -> description("action/function.config_core_tools"));
        ...
        final ActionView.Builder createFunctionView = new ActionView.Builder("Function App")
            .title(s -> Optional.ofNullable(s).map(r -> description("action/function.create_app.group", ((ResourceGroup) r).getName())).orElse(null))
        ...
        final ActionView.Builder enableRemoteDebuggingView = new ActionView.Builder("Enable Remote Debugging")
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.enable_remote_debugging.app", ((FunctionAppBase<?, ?, ?>) r).getName())).orElse(null))
        ...
        final ActionView.Builder disableRemoteDebuggingView = new ActionView.Builder("Disable Remote Debugging")
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.disable_remote_debugging.app", ((FunctionAppBase<?, ?, ?>) r).getName())).orElse(null))
                .enabled(s -> s instanceof FunctionAppBase<?, ?, ?> && ((AzResourceBase) s).getFormalStatus().isRunning() && ((FunctionAppBase<?, ?, ?>) s).isRemoteDebugEnabled());
        ...
        final ActionView.Builder attachDebuggerView = new ActionView.Builder("Attach Debugger", AzureIcons.Action.ATTACH_DEBUGGER.getIconPath())
                .title(s -> Optional.ofNullable(s).map(r -> description("action/function.start_remote_debugging.app", ((FunctionAppBase<?, ?, ?>) r).getName())).orElse(null))
